        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="space-y-6 text-center">
            <h1 className="text-4xl md:text-5xl font-bold">
              About MERN Boilerplate
            </h1>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              A comprehensive, production-ready MERN stack boilerplate designed
              to accelerate your development process and ensure best practices
              from day one.
            </p>
          </div>
        </div>
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center space-y-4 mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Everything you need to build secure, scalable, and modern
              applications
            </p>
          </div>
          ...
          <div className="rounded-2xl bg-gradient-to-r from-primary/10 via-primary/5 to-primary/10 border border-primary/20 p-8 md:p-12 text-center space-y-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground text-lg">
                Start building your next project with our comprehensive
                boilerplate
              </p>
            </div>
